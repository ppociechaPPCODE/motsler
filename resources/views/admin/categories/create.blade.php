...
@section('content')
    <h1 class="mb-6 text-2xl font-bold text-primary">Nowa kategoria</h1>
    <form method="post" action="{{ route('admin.categories.store') }}" class="max-w-xl space-y-6 rounded-xl border border-zinc-200 bg-white p-6 shadow-sm">
        @csrf
