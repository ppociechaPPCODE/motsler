...
@section('meta_description', __('page.seo_description_about'))
@section('content')
@php
    $l = app()->getLocale();
@endphp
...
<div class="space-y-0">
    ...
    <section class="bg-white px-6 py-14 sm:px-10">
        <div class="mx-auto grid w-full max-w-[1650px] gap-10 lg:grid-cols-2 lg:items-center">
            <div>
                <h2 class="text-4xl font-semibold text-primary">Dlaczego <strong>MOTSLER?</strong></h2>
                ...
                <p class="mt-4 text-lg leading-8 text-primary">
            ...
            <div class="grid gap-6 sm:grid-cols-2">
                <div class="rounded-[20px] bg-[#edf2f7] p-6 text-center">
                    <div class="text-5xl font-bold text-primary">16</div>
                    <div class="mt-2 text-xl font-semibold text-primary">Lat doświadczenia</div>
                </div>
                <div class="rounded-[20px] bg-[#edf2f7] p-6 text-center">
                    <div class="text-5xl font-bold text-primary">100</div>
                    <div class="mt-2 text-xl font-semibold text-primary">Zadowolonych klientów</div>
                </div>
                <div class="rounded-[20px] bg-[#edf2f7] p-6 text-center sm:col-span-2">
                    <div class="text-xl font-semibold text-primary">Wsparcie techniczne, szkolenia i doradztwo</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#edf2f7] px-6 py-14 sm:px-10">
        <div class="mx-auto w-full max-w-[1650px]">
            <h2 class="text-center text-4xl font-semibold text-primary">Nasze wartości</h2>
            <div class="mt-10 grid gap-6 md:grid-cols-3">
                <div class="rounded-[20px] bg-white p-6 text-center">
                    <h3 class="text-2xl font-semibold text-primary">Niezawodność</h3>
                    <p class="mt-3 text-primary">Projektujemy rozwiązania gotowe na codzienną, intensywną pracę.</p>
                </div>
                <div class="rounded-[20px] bg-white p-6 text-center">
                    <h3 class="text-2xl font-semibold text-primary">Efektywność</h3>
                    <p class="mt-3 text-primary">Dbamy, aby maszyny realnie zwiększały zyski i skracały czas pracy.</p>
                </div>
                <div class="rounded-[20px] bg-white p-6 text-center">
                    <h3 class="text-2xl font-semibold text-primary">Rozwój</h3>
                    <p class="mt-3 text-primary">Pomagamy klientom rozbudować ofertę usług i skalować biznes.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="bg-[#00264b] px-6 py-14 text-white sm:px-10">
        <div class="mx-auto w-full max-w-[1650px] text-center">
            ...
            <a href="{{ locale_route('contact', ['locale' => $l]) }}" class="mt-8 inline-flex rounded-full bg-primary px-8 py-4 text-sm font-semibold uppercase text-white">Wyślij zapytanie</a>
        </div>
    </section>
</div>
@endsection
